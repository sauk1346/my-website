...
- [ARPA2.pdf](/inacap/mvfm01/docs/ARPA12.pdf)
- [ARPA2_Extension.pdf](/inacap/mvfm01/docs/ARPA12_Extension.pdf)
...
<SmartFigure
	...
	alt="Función cuadrada f(x)"
	caption="Función cuadrada f(x)"
	size="large"
/>
...
<SmartFigure
	...
	alt="Cálculo vértice de f(x)"
	caption="Cálculo vértice de f(x)"
	size="large"
/>

<SmartFigure
	src="/inacap/mvfm01/images/fig25.svg"
	alt="Gráfica función cuadrada f(x)"
	caption="Gráfica función cuadrada f(x)"
	lightbox={true}
	size="large"
/>
...
<SmartTable
  tableLayout="auto"
  headers={["Variable","Significado en el lanzamiento del objeto"]}
  rows={[
...
<SmartFigure
	...
	alt="Modelos cuadráticos f(x) y h(x), sus vertices y raíces"
	caption="Modelos cuadráticos f(x) y h(x), sus vertices y raíces"
	size="medium"
/>

<SmartFigure
	src="/inacap/mvfm01/images/fig27.svg"
	alt="Gráficas modelos cuadráticos f(x) y h(x)"
	caption="Gráficas modelos cuadráticos f(x) y h(x)"
	lightbox={true}
	size="large"
/>
...
<SmartTable
  tableLayout="auto"
  headers={["Modelo","altura inicial [m]","altura máx [m]","Altura [m] a los 5seg","velocidad inicial [m/s]","tiempo de vuelo [s]"]}
  rows={[
