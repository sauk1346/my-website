...
**Material Clase:** <a href="/ti3v11/docs/clase04.pdf" target="_blank" rel="noopener noreferrer" className={styles.link}>clase04.pdf</a>

- PSeInt: <a href='https://pseint.sourceforge.net' target="_blank" rel="noopener noreferrer" className={styles.link}>https://pseint.sourceforge.net</a>
