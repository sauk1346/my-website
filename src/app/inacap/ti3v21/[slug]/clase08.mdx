...
## Principios de POO
Tiene 3 principios importantes:

1. **Encapsulamiento:** protege los datos de la clase. Ayuda a evitar la modificación no controlada.

2. **Polimorfismo:** permite que diferentes clases utilicen métodos con el mismo nombre, adaptándolos a su comportamiento específico.

3. **Herencia:** Permite que clases hijas, hereden atributos y métodos de la clase padre.
