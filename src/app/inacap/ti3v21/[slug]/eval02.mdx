...
- **Instrucciones:** <ExternalLink href="/inacap/ti3v21/docs/prueba02.pdf">prueba02.pdf</ExternalLink>
...
<img 
    src="/inacap/ti3v21/images/fig02.png"
...
1. El tipo de vehículo y valor por minutos dependerá de la cantidad de ruedas en la clase `Tipo`
	1. 2 ruedas = Motocicles (\$300 x min)
	2. 3 ruedas = Trimoto (\$600 x min)
	3. 4 ruedas = Automóvil (\$900 x min)
	4. +4 ruedas = Camión (\$1500 x min)
...
```
<TerminalOutput withBg>
{`Vehiculo patente MNO456 ha salido. Total a pagar: 27000 pesos.

Total pagado por MNO456: 27000 pesos.`}
</TerminalOutput>
