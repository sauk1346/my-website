...
- **Instrucciones:** <a href="/ti3v21/docs/prueba02.pdf" target="_blank" rel="noopener noreferrer" className={styles.link}>prueba02.pdf</a>
...
<details>
<summary style={{color:'red'}}>Código</summary>
...
<br/>
<details>
	<summary style={{color:'red'}}>Pruebas</summary>
