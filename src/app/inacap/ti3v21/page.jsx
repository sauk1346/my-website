...
export default function Ti3v21() {
    ...
    const lectureData = [
        ...
        { week: '04', lecture: '07', date: 'Sáb 16, Nov 2024', description: 'Librerías Python con conexión a base de datos' },
        { week: '', lecture: '08', date: 'Sáb 16, Nov 2024', description: 'Manipulación de registros' },
        { week: '', lecture: '09', date: 'Sáb 16, Nov 2024', description: 'Manejo de excepciones y jerarquías' },
        { week: '05', lecture: '-', date: 'Sáb 23, Nov 2024', description: 'Repaso contenidos de la Unidad' },
        { week: '06', lecture: '10', date: 'Sáb 30, Nov 2024', description: 'Scripts seguros de Python' },
        { week: '', lecture: '11', date: 'Sáb 30, Nov 2024', description: 'Librerías para consumo de datos externos' },
        { week: '07', lecture: '12', date: 'Sáb 07, Dic 2024', description: 'Clase de Python con deserialización de información' },
        { week: '', lecture: '13', date: 'Sáb 07, Dic 2024', description: 'Registra data obtenida en Base de datos' },
        { week: '08', lecture: '14', date: 'Sáb 14, Dic 2024', description: 'Requerimientos de la solución' },
        { week: '', lecture: '15', date: 'Sáb 14, Dic 2024', description: 'Diseño de diagrama de clases y casos de uso' },
        { week: '09', lecture: '16', date: 'Sáb 21, Dic 2024', description: 'Aplicando metodologías ágiles de desarrollo' },
        { week: '', lecture: '17', date: 'Sáb 21, Dic 2024', description: 'Solución con hash y conectada a base de datos' },
    ];
