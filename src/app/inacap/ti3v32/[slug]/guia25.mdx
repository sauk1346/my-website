...
- **Colección:** peliculas
- **JSON: <a href="https://drive.google.com/file/d/1G5YIffrCRilK6LFRFoKVVb9kw9T0MqVs/view?usp=sharing" target="_blank" rel="noopener noreferrer" className={styles.link}>peliculas.json</a>**
...
## Ejercicio 19
Filtrar películas producidas fuerda de "United States of America"
