...
1. **Configurar Templates (1):** Crear carpeta `templates/` y subcarpeta `miapp/` (la subcarpeta es por buenas prácticas)
	```sh
	mkdir -p ./miapp/templates/miapp/
	```

2. **Configurar Template (2):** Crear template `info.html`
	```html
...
5. **Realizar Pruebas:** Ejecutar servidor y verificar ruta
	...
	<SmartFigure
        id="pagina-info"
        src="/inacap/ti3v41/images/fig39.png"
        alt="Página 'info'"
        caption="Página 'info'"
        size="large"
    />
...
4. **Realizar Pruebas:** Ejecutar servidor y verificar ruta
    ...
    ```
	<SmartFigure
        id="pagina-info-mejorada"
        src="/inacap/ti3v41/images/fig42.png"
        alt="Página 'info' mejorada"
        caption="Página 'info' mejorada"
        size="large"
    />

### Ejercicio 02

- Generar 1 documento html en la carpeta `templates/` (**index.html**)
...
8. **Realizar Pruebas:** Ejecutar servidor y verificar ruta
    ...
    <SmartFigure
        id="pagina-index"
        src="/inacap/ti3v41/images/fig43.png"
        alt="Página 'index'"
