...
> **Input:** ratings = [1,0,2]
> **Output:** 5
> **Explicación:** Puedes asignar al primer, segundo y tercer niño con 2, 1, 2 dulces respectivamente.

**Ejemplo 2:**
> **Input:** ratings = [1,2,2]
> **Output:** 4
> **Explicación:** Puedes asignar al primer, segundo y tercer niño con 1, 2, 1 dulces respectivamente.
> El tercer niño obtiene 1 dulce porque satisface las dos condiciones anteriores.
