...
| name        | varchar |
+-------------+---------+
"id" es la clave primaria de esta tabla. Se garantiza que el nombre del departamento no es NULL.
...
> **Explicación:** Max y Jim ambos tienen el salario más alto en el departamento de IT, y Henry tiene el salario más alto en el departamenteo de Sales.
