# (Proyecto Tienda) Inicio - Módulo Admin

- Desarrollar un proyecto llamado **TiendaProductos**
- Desarrollar una aplicación llamada **Tienda**
...
2. **Crear App:** Llamada `tienda`
    ```sh
    python manage.py startapp tienda
    ```

3. **Configuración Inicial:** Agregar `tienda` en `settings.py`
...
5. **Configurar Base de datos:** Crear archivos de migración con los cambios realizados y aplicarlos a la base de datos
    ```sh
    ...
    Running migrations:
      ...
      Applying tienda.0001_initial... OK`}
    </TerminalOutput>
...
8. **Agregar Datos:** Levantar servidor y agregar productos a través del módulo Admin
    ...
    <SmartFigure
        ...
        src="/inacap/ti3v41/images/fig026.png"
    ...
    <SmartFigure
        ...
        src="/inacap/ti3v41/images/fig027.png"
        alt="Productos ingresados"
        caption="Productos ingresados"
        size="large"
    />

9. **Configurar Templates (1):** Crear directorio `./tienda/templates/tienda` y agregar template `index.html`
    ```sh
    mkdir -p ./tienda/templates/tiendita
    ```
    ```html
...
11. **Configurar Enrutamiento:** Crear `./tienda/urls.py` y agregarlo a `./tiendaproductos/urls.py`
    ```python
    #./tienda/urls.py
...
12. **Configurar Templates (2):** Agregar los datos creados en la vista `index` (el contexto)
    ```html
    <!-- ./tienda/templates/tienda/index.html -->
...
13. **Verificar Datos:** Verificar que se muestran correctamente los datos (contadores) en la vista `index`
   ...
   <SmartFigure
        id="vista-index"
        src="/inacap/ti3v41/images/fig028.png"
