# (Proyecto Tienda) Vistas genéricas de lista
...
2. **Configurar Base de datos:** Crear archivos de migración con los cambios realizados y aplicarlos a la base de datos
    ...
    {`Migrations for 'tienda':
      tienda/migrations/0002_producto_categoria.py
    ...
    Running migrations:
      Applying tienda.0002_producto_categoria... OK`}
    </TerminalOutput>
...
4. **Realizar Pruebas:** Levantar servidor y verificar nuevo campo
    ...
    ```
    ```sh
    http://127.0.0.1:8000/admin/tienda/producto/1/change/
    ```
    <SmartFigure
        id="relacion-modelos-campo-categoria"
        src="/inacap/ti3v41/images/fig029.png"
        alt="Relación entre Modelos mediante nuevo campo 'categoria'"
        caption="Relación entre Modelos mediante nuevo campo 'categoria'"
        size="large"
    />
    <SmartFigure
        id="lista-productos-actualizados"
        src="/inacap/ti3v41/images/fig030.png"
...
2. **Realizar Pruebas:** Levantar servidor y verificar cambios
    ...
    ```
    ```sh
    http://127.0.0.1:8000/admin/tienda/categoria/1/change/
    ```
    <SmartFigure
        id="categoria-abarrotes"
        src="/inacap/ti3v41/images/fig031.png"
...
2. **Configurar Templates (2):** Modificar `index.html` para que acepte el template `base.html`
    ```html
    <!-- ./tienda/templates/tienda/index.html -->
...
3. **Realizar Pruebas:** Levantar servidor y verificar ruta
    ...
    <SmartFigure
        ...
        src="/inacap/ti3v41/images/fig032.png"
        alt="Página 'index' con template base"
        caption="Página 'index' con template base"
        size="large"
    />

### Agregar Vistas genéricas de lista (1)

Agregar vista genérica de lista para el modelo `Cliente`

1. **Agregar Datos:** añadir datos al modelo `Cliente`
    <SmartFigure
        id="datos-modelo-cliente"
        src="/inacap/ti3v41/images/fig033.png"
        alt="Datos para el modelo Cliente"
        caption="Datos para el modelo Cliente"
        size="large"
    />

2. **Configurar Vistas:** Crear la 'vista genérica de lista' `ClienteListView`
    ```python
    #./tienda/views.py
...
3. **Configurar Templates (1):** Agregar template `cliente_list.html` para la 'vista genérica de lista' `ClienteListView`
    ```html
...
4. **Configurar Enrutamiento:** Agregar la ruta para la 'vista genérica de lista' `ClienteListView`
    ```python
    #./tienda/urls.py
...
6. **Realizar Pruebas:** Levantar servidor y verificar ruta
    ...
    ```
    ```sh
    http://127.0.0.1:8000/tienda/clientes/
    ```
    <SmartFigure
        id="pagina-clientes-vistas-genericas-de-lista"
        src="/inacap/ti3v41/images/fig034.png"
        alt="Página 'clientes' usando Vistas genéricas de lista"
        caption="Página 'clientes' usando Vistas genéricas de lista"
        size="large"
    />

### Agregar Vistas genéricas de lista (2)

Agregar las 'vistas genéricas de lista' para los modelos `Producto` y `Categoria`

1. **Configurar Vistas:** Agregar las 'vistas genéricas de lista' `ProductoListView` y `ClienteListView` en `views.py`
    ```python
    #./tienda/views.py
    from django.shortcuts import render
    from .models import Cliente, Producto, Categoria
...
3. **Configurar Enrutamiento:** Agregar las rutas para las 'vistas genéricas de lista' `ProductoViewList` y `CategoriaViewList`
    ```python
    #./tienda/urls.py
    from django.urls import path
    from . import views
...
5. **Realizar Pruebas:** Levantar servidor y verificar rutas
    ...
    <SmartFigure
        ...
        src="/inacap/ti3v41/images/fig035.png"
        alt="Página 'productos' usando Vistas genéricas de lista"
        caption="Página 'productos' usando Vistas genéricas de lista"
        size="large"
    />
    ```sh
    http://127.0.0.1:8000/tienda/categorias/
    ```
    <SmartFigure
        id="pagina-categorias-vistas-basadas-en-clases"
        src="/inacap/ti3v41/images/fig036.png"
        alt="Página 'categorias' usando Vistas genéricas de lista"
        caption="Página 'categorias' usando Vistas genéricas de lista"
        size="large"
    />