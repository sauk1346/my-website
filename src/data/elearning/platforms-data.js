export const platformsData = {
  coursera: {
    ...
    image: "/logos/coursera.png", // ← Cambié 'logo' por 'image'
    courses: [
      {
        id: 1,
  ...
  codigofacilito: {
    name: "CódigoFacilito",
    description: "Plataforma de programación en español",
    image: "/logos/codigofacilito.png", // ← Cambié 'logo' por 'image'
    courses: [
      {
        id: 4,
  ...
  devtalles: {
    ...
    image: "/logos/devtalles.png", // ← Cambié 'logo' por 'image'
    courses: [
      {
        id: 6,
  ...
  platzi: {
    name: "Platzi",
    description: "Educación online en tecnología",
    image: "/logos/platzi.png", // ← Cambié 'logo' por 'image'
    courses: [
      {
        id: 8,
  ...
  udemy: {
    ...
    image: "/logos/udemy.png", // ← Cambié 'logo' por 'image'
    courses: [
      {
        id: 10,
